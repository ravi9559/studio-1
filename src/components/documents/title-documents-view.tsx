    ...
    <DialogContent className="sm:max-w-md">
      <form onSubmit={handleSubmit}>
        <DialogHeader>
          ...
          <DialogDescription>
            Record a file in "{folderName}". A placeholder file will be created for download.
          </DialogDescription>
        </DialogHeader>
        <div className="grid gap-4 py-4">
          <div className="grid grid-cols-4 items-center gap-4">
    ...
    <Card>
      <CardHeader>
        <div>
            ...
            <CardDescription>
            Folders are automatically generated based on family heads. You can add file records and create sub-folders within this structure.
            </CardDescription>
        </div>
      </CardHeader>
      <CardContent>
